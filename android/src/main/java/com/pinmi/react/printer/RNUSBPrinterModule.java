...
public class RNUSBPrinterModule extends ReactContextBaseJavaModule implements RNPrinterModule {
    ...
    @ReactMethod
    public void connectPrinter(Integer vendorId, Integer productId, Integer deviceId, Callback successCallback, Callback errorCallback) {
        adapter.selectDevice(USBPrinterDeviceId.valueOf(vendorId, productId, deviceId), successCallback, errorCallback);
    }

    @ReactMethod
    public void connectStampPrinter(Integer vendorId, Integer productId, Integer deviceId, Callback successCallback, Callback errorCallback) {
        adapter.selectStampDevice(USBPrinterDeviceId.valueOf(vendorId, productId, deviceId), successCallback, errorCallback);
    }
